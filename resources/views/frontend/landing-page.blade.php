					...
					<div class="card">
						...
						<div class="category-option">
							<ul>
								...
								<li><a href="#">Fresh Apple</a></li>
								<li><a href="#">Fresh Onion</a></li>
								<li><a href="#">Fresh Bananas</a></li>
								<li><a href="#">Vegetables</a></li>
								<li><a href="#">Hilsa fish</a></li>
						...
						<div class="col-md-3">
							<div class="info-contact">
								...
								<div class="contact-number">
									<p>+9568796</p><span>24/7 support</span>
								</div>
							</div>
						</div>
					</div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> March 4,2020</li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> April 10,2020</li>
                                <li><i class="fa fa-comment-o"></i> 5</li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> September 20,2020</li>
                                <li><i class="fa fa-comment-o"></i> 5</li>
                            </ul>
                            <h5><a href="#">Visit the clean farm in Bangladesh</a></h5>
                            <p>Sed quia non numquam modi tempora indunt ut labore et dolore magnam aliquam quaerat </p>
                        </div>
                    </div>
                </div>
